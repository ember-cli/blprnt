...
MockProject.prototype.name = function() { return 'mock-project'; };
...
var Blueprint = proxyquire('../../lib/blueprint', {
...
var defaultBlueprints = path.resolve(__dirname, '..', '..', 'tests-fixtures', 'blueprints');
var fixtureBlueprints = path.resolve(__dirname, '..', '..', 'tests-fixtures', 'blueprints');
...
describe('Blueprint', function() {
  ...
  describe('.lookup', function() {
    ...
    it('finds blueprints a blueprint package', function() {
...
help in detail');
  ...
  describe('basic blueprint installation', function() {
    ...
    it('re-installing conflicting files', function() {
      td.when(ui.prompt(td.matchers.anything())).thenReturn(
        RSVP.Promise.resolve({ answer: 'skip' }),
        RSVP.Promise.resolve({ answer: 'overwrite' }));
  ...
  describe('load', function() {
    ...
    it('loads blueprints with an index.js', function() {
